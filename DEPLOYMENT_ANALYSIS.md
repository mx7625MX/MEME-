...
```
本地成本（按中等配置电脑计算）：
- 电费：$15-30/月（24/7运行，功耗150W，电费$0.15/kWh）
- 硬件折旧：$40/月（$2000电脑，4年折旧期）
- 网络成本：$50/月（需要稳定的商业级网络）
- 时间成本：$50/月（每月约5小时维护，按$10/小时）
总计：$155-170/月

云端成本（个人使用）：
- Vercel：$0/月（免费额度：100GB带宽）
- Supabase：$0/月（免费额度：500MB数据库）
总计：$0/月

节省：$155-170/月 = $1860-2040/年
```
