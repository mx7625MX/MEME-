    ...
    const sampleWallets = [
      {
        ...
        address: "5xKpDvKvV2Z8JmX4k9P2nF6L7Q3rT8sY1Z3aB5cD7eG9h",
        balance: "1234.56",
        isActive: true,
      },
      {
        name: "BSC 钱包",
        chain: "bsc" as const,
        address: "0x7aB3fB9C8d6E5f4a2b1c0d9e8f7a6b5c4d3e2f1A0",
        balance: "2.5",
        isActive: true,
      },
      {
        name: "ETH 备用钱包",
        chain: "eth" as const,
        address: "0x3dC8a1B2c3D4e5F6a7b8c9d0E1f2A3b4C5d6E7f8A9",
        balance: "0",
        isActive: false,
      },
    ];
