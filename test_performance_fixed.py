...
# 测试2：闪电卖出API - 使用 tokens/sell
print("\033[1;33m[测试2] 闪电卖出API (tokens/sell)\033[0m")
...
try:
    ...
    print(f"响应状态码: {sell_response.status_code}")
    ...
    if sell_response.status_code == 200:
        try:
            ...
            print(f"响应内容: {sell_response.text[:200]}")
    else:
        print(f"\033[0;31m✗ 卖出请求失败\033[0m")
        print(f"响应内容: {sell_response.text[:500]}")
except Exception as e:
    print(f"\033[0;31m✗ 卖出请求失败\033[0m")
    print(f"错误: {str(e)}")
...
print("性能分析:")
if total_time < 1:
    print("  \033[0;32m✓ 极快\033[0m - 全程 < 1秒")
elif total_time < 3:
    print("  \033[0;32m✓ 快速\033[0m - 全程 < 3秒")
elif total_time < 5:
    print("  \033[1;33m⚠ 一般\033[0m - 全程 < 5秒")
else:
    print("  \033[0;31m✗ 慢\033[0m - 全程 > 5秒")
print()
